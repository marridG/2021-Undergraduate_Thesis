...
from encoding_v3.encode_v3 import encode
from encoding_v3.decode_v3 import decode
import utils
...
def do(setting_env_key, setting_dec_key):
    ...
    data_sample = data_obj.get_sample(category_idx=1, sign_idx=74)
    print(data_sample)
    ...
    sign_board_obj.render().savefig("./canvas_img/canvas_v3__%s.png" % setting_env_key)
