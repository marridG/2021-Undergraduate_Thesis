...
def encode(sample: Dict[str, Union[str, None, int, Dict[str, int]]],
    ...
    _res_cat_1_pat = pattern_v2_1.get_bin_pattern_by_idx(idx=_category_1)  # 4 digit <np.ndarray>
    _res_1_cat_1 = pattern_v2_1.get_sequence_by_pattern(pattern=_res_cat_1_pat)  # 8 digit
    res[-2, :] = _res_1_cat_1
