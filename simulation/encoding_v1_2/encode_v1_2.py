...
from encoding_v1_2 import pattern_v1_2
...
def encode(sample: Dict[str, Union[str, None, int, Dict[str, int]]]) -> np.ndarray:
    ...
    _res_2_cat_1 = pattern_v1_2.get_bin_pattern_by_idx(idx=_category_1)  # <np.ndarray>
    res[1, :] = _res_2_cat_1
    ...
    if sample["num"] is None:
        ...
        _num_bin = pattern_v1_2.dec_2_non_dup_bin(num=sample["num"], digit=res_length,
    ...
    _cat_2_bin = pattern_v1_2.dec_2_non_dup_bin(num=_category_2, digit=res_length,
