...
def main():
    ...
    parser.add_argument(
        ...
        help=".pcd file path.",
        type=str,
        default=r"D:\Workspace\Pycharm\In-Class Exercises\Undergraduate Thesis\detection\data_prep\seq60"
    )
    parser.add_argument(
        "--bin_path",
        help=".bin file path.",
        type=str,
        default=r"D:\Workspace\Pycharm\In-Class Exercises\Undergraduate Thesis\detection\data_prep\bin"
    )
    parser.add_argument(
        "--file_name",
        help="File name.",
    ...
    for pcd_file in tqdm(pcd_files):
        ...
        # pc = pyntcloud.PyntCloud.from_file(pcd_file)
